...
const imageUtils = require(__base + 'core/utils/image'),
  ...
  documentManager = require(__base + 'manager/document/documentManager');
...
var filterProvision = (params, version) =>{
	...
	if(params.fromLine && params.toLine && version){
		...
		return xpathUtils.extractLines(doc, parseInt(params.fromLine), parseInt(params.toLine));
