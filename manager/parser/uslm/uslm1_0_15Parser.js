...
module.exports = class Uslm1_0_15Parser extends XmlParser{
  constructor() {
    super('uslm1.0.15', 'http://xml.house.gov/schemas/uslm/1.0', __base + 'manager/parser/uslm/xsl/uslm2MicroData.xsl', __base + 'manager/parser/uslm/xsl/uslm2MicroData.xsl');
